...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
    <div class="max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">In Progress Complaints</h2>
            <p class="text-gray-500 dark:text-gray-400">Review complaints that are currently being worked on.</p>
        </div>

        <!-- Complaints List -->
        <div class="p-6 space-y-4">
            @if($inProgressComplaints->isEmpty())
                <div class="p-4 text-center bg-gray-100 dark:bg-gray-700 rounded-lg">
                    <p class="text-gray-500 dark:text-gray-300">No in-progress complaints found.</p>
                </div>
            @else
                @foreach ($inProgressComplaints as $complaint)
